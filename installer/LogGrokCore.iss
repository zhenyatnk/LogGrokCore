...
#define MyAppURL "https://github.com/zhenyatnk/LogGrokCore"
...
OutputBaseFilename=LogGrokCore-{#MyAppVersion}-{#MyArchSuffix}-setup
...
[Registry]
Root: HKA; Subkey: "Software\Classes\.log\OpenWithProgids"; ValueType: string; ValueName: "LogGrokCore.log"; ValueData: ""; Flags: 64bit uninsdeletevalue; Tasks: fileassoc_log
Root: HKA; Subkey: "Software\Classes\.txt\OpenWithProgids"; ValueType: string; ValueName: "LogGrokCore.txt"; ValueData: ""; Flags: 64bit uninsdeletevalue; Tasks: fileassoc_txt
Root: HKA; Subkey: "Software\Classes\LogGrokCore.log"; ValueType: string; ValueName: ""; ValueData: "Log File"; Flags: 64bit uninsdeletekey; Tasks: fileassoc_log
Root: HKA; Subkey: "Software\Classes\LogGrokCore.log\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\{#MyAppExeName},0"; Flags: 64bit; Tasks: fileassoc_log
Root: HKA; Subkey: "Software\Classes\LogGrokCore.log\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#MyAppExeName}"" ""%1"""; Flags: 64bit; Tasks: fileassoc_log
Root: HKA; Subkey: "Software\Classes\LogGrokCore.txt"; ValueType: string; ValueName: ""; ValueData: "Text File"; Flags: 64bit uninsdeletekey; Tasks: fileassoc_txt
Root: HKA; Subkey: "Software\Classes\LogGrokCore.txt\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\{#MyAppExeName},0"; Flags: 64bit; Tasks: fileassoc_txt
Root: HKA; Subkey: "Software\Classes\LogGrokCore.txt\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#MyAppExeName}"" ""%1"""; Flags: 64bit; Tasks: fileassoc_txt
